...
["80","General questions relating to linguistics and literature",/\blanguage|linguistics|lexicography\b/],["81","Linguistics",/\blinguistics|grammar|phonetics|semantics\b/],["82","Literature",/\bliterature|poetry|novel|fiction|prose\b/],["821.111","English literature",/\benglish literature\b/],["821.111-2","English literature — drama",/\benglish drama|drama in english\b/],
...
[/^dictionary of language and literature$/i,"80(038)","Language and literature","Dictionary of language and literature","80 = General questions relating to linguistics and literature; (038) = Dictionaries.","UDC Summary verified"],
...
[/^handbook of science and technology$/i,"5/6(035)","Science and technology","Handbook of science and technology","5/6 = Mathematics/natural sciences through applied sciences/technology; (035) = Handbooks. Manuals.","UDC Summary verified"],
[/^manual of science and technology$/i,"5/6(035)","Science and technology","Manual of science and technology","5/6 = Mathematics/natural sciences through applied sciences/technology; (035) = Handbooks. Manuals.","UDC Summary verified"],
[/^science and technology$/i,"5/6","Science and technology","Science and technology","5/6 = Mathematics/natural sciences through applied sciences/technology; / expresses consecutive extension.","UDC hierarchy cross-check"],
...
function localClassify(title){const t=norm(title);for(const e of exact){if(e[0].test(t))return result(title,e[1],e[2],e[3],e[4],e[5],true)}
 ...
 if(/\b(dictionary|lexicon|glossary)\b/.test(t)&&/\b(language|literature|linguistics)\b/.test(t))return result(title,"80(038)","Language and literature","Dictionary of language and literature","80 = General questions relating to linguistics and literature; (038) = Dictionaries.","UDC Summary verified",true);
 if(/\b(handbook|manual|handbooks|manuals)\b/.test(t)&&/\b(science|technology|science and technology)\b/.test(t))return result(title,"5/6(035)","Science and technology","Handbook of science and technology","5/6 = Mathematics/natural sciences through applied sciences/technology; (035) = Handbooks. Manuals.","UDC Summary verified",true);
 // Agriculture: process + crop is deliberately more specific than broad 63.
 if(/\b(harvest|harvesting)\b/.test(t)&&/\b(wheat|maize|corn|cereal|grain)\b/.test(t))return result(title,"631.55:633.1","Agriculture","Harvesting of cereals","631.55 = Gathering/harvesting; 633.1 = Cereals/grain crops; : expresses their relation.","UDC evidence cross-check",true);
 ...
 return result(title,"","Unresolved subject","Manual verification required","No sufficiently specific UDC Summary-backed rule was found for this title. The system does not invent a class.","UNRESOLVED — verify against UDC Summary/MRF",false);
}
