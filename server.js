...
[/^dictionary of language and literature$/i,"(038)","Reference works","Dictionary of language and literature","(038) = Dictionaries (common auxiliary of form); the title is a dictionary covering language and literature and does not specify a particular language.","Official UDC Summary form auxiliary match"],
...
function localClassify(title){const t=norm(title);for(const e of exact){if(e[0].test(t))return result(title,e[1],e[2],e[3],e[4],e[5],true)}
 ...
 if(/\b(dictionary|lexicon|glossary)\b/.test(t)&&/\b(language|literature)\b/.test(t))return result(title,"(038)","Reference works","Dictionary / language and literature","(038) = Dictionaries, the UDC common auxiliary of form for dictionary works. If a specific language or subject is stated, a more specific subject-plus-(038) notation may be used.","Reasoned from UDC Summary",true);
