...
[/^history of bharat$/i,"94(540)","History","History of India (Bharat)","94 = History; (540) = India.","UDC Summary hierarchy + place auxiliary"],
[/^geography of bharat$/i,"91(540)","Geography","Geography of India (Bharat)","91 = Geography; (540) = India.","UDC Summary hierarchy + place auxiliary"],
[/^economy of india$/i,"330(540)","Economics","Economy of India","330 = Economics; (540) = India.","UDC Summary hierarchy + place auxiliary"],
[/^economics of india$/i,"330(540)","Economics","Economics of India","330 = Economics; (540) = India.","UDC Summary hierarchy + place auxiliary"],
[/^history of punjab$/i,"94(540.15)","History","History of Punjab","94 = History; (540.15) = Punjab.","UDC Summary place auxiliary"],
[/^indian constitution$/i,"342(540)","Law","Constitutional law of India","342 = Constitutional law; (540) = India.","UDC Summary hierarchy + place auxiliary"],
...
function localClassify(title){const t=norm(title);for(const e of exact){if(e[0].test(t))return result(title,e[1],e[2],e[3],e[4],e[5],true)}
 ...
 if(/\b(harvest|harvesting)\b/.test(t)&&/\b(wheat|maize|corn|cereal|grain)\b/.test(t))return result(title,"633.1:631.55","Agriculture","Harvesting of cereals","633.1 = Cereals/grain crops; 631.55 = harvesting; : expresses the relation.","UDC Summary hierarchy + relation synthesis",true);
